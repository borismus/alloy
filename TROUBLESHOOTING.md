# PromptBox Troubleshooting Guide
...
**Solutions**:
1. Choose a folder you have write access to (e.g., `~/Documents/promptbox-vault`)
...
4. **File an issue**: https://github.com/your-repo/promptbox/issues
