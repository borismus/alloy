...
- [ ] Canonical config.yaml schema (v1) — breaking 0.3→0.4 change, NO back-compat/migration. Design decided (see notes below). Replace the accreted config formats with one versioned, camelCase schema and make Rust the single parser.
