...
This guide explains how to use the Playwright MCP (Model Context Protocol) server integration to test the PromptBox Tauri app with AI assistance.
...
```
"Explore the PromptBox UI and tell me what features are available"
```
